//
//  XBUniversalCell_icon_title_subTitle_rightIcon.m
//  TongMeng
//
...
@implementation XBUniversalCell_icon_title_subTitle_rightIcon
...
- (void)setupSubviews
{
    self.btn_iconTitle = ({
        ...
        [btn mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.left.equalTo(self.contentView).offset(XBUniversalCell_float_leadingSpace);
        }];
